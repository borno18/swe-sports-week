...
export function SportsDirectory({ sports }: { sports: Sport[] }) {
  ...
  return (
    <div className="page-shell">
      <header className="page-hero">
        <span className="eyebrow">{sports.length} sports · {sports.reduce((sum, sport) => sum + sport.participants, 0)} players / teams</span>
